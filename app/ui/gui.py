...
class GuiApp:
    ...
    class MainWindow(QMainWindow):
        def __init__(self):
            ...
            self.tab_stack = GuiApp.TabStack()
            self.bottom_bar = GuiApp.BottomBar()

            self.bottom_bar.switch_tab.connect(self.tab_stack.set_tab)
    ...
    class AccountsTab(QWidget):
        def __init__(self):
            ...
            self.accounts_add_content = GuiApp.AccountsAddContent()
            self.accounts_add_content.switch_to_main.connect(
                lambda: self.stack.setCurrentIndex(0)
            )

            self.stack.addWidget(self.accounts_content)
            self.stack.addWidget(self.accounts_add_content)
    ...
    class AccountsEditContent(QWidget):
        pass
